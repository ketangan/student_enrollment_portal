# Generated by Django 6.0.1 on 2026-01-30 01:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0003_alter_school_options_submissionfile'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('add', 'Add'), ('change', 'Change'), ('delete', 'Delete'), ('action', 'Action')], max_length=16)),
