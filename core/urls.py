...
urlpatterns = [
    ...
    path("schools/<slug:school_slug>/apply/pay/<str:draft_token>/bypass/", views.apply_payment_bypass_view, name="apply_payment_bypass"),
    ...
    path("schools/<slug:school_slug>/admin/email-templates/<int:template_id>/deactivate/", views_school_email_templates.school_email_template_delete_view, name="school_email_template_delete"),
    path("schools/<slug:school_slug>/admin/email-templates/<int:template_id>/reactivate/", views_school_email_templates.school_email_template_reactivate_view, name="school_email_template_reactivate"),
    path("schools/<slug:school_slug>/admin/custom-tokens/add/", views_school_email_templates.school_custom_token_create_view, name="school_custom_token_create"),
